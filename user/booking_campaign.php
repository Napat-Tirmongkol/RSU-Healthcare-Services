                ...
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow relative">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between mt-6 pt-4 border-t border-gray-50">
                            ...
                            <?php if (!$isFull): ?>
                                <a href="booking_date.php?campaign_id=<?= $c['id'] ?>" class="bg-[#2e9e63] hover:bg-green-700 text-white w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg shadow-green-200 transition-all active:scale-95">
