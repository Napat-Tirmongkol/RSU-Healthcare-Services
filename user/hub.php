...
<head>
    ...
    <style>
        ...
        body { font-family: 'Prompt', sans-serif; -webkit-tap-highlight-color: transparent; background-color: #F8FAFF; }
            ...
            <div onclick="showProfile()" class="relative overflow-hidden bg-gradient-to-br from-[#0052CC] via-[#0066FF] to-[#0052CC] rounded-[3rem] p-8 shadow-[0_25px_50px_-12px_rgba(0,82,204,0.3)] group active:scale-[0.97] transition-all cursor-pointer">
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-1 mb-8">
                        ...
                        <h3 class="text-white text-xl font-black tracking-tight uppercase"><?= $user['student_id'] ?></h3>
                    </div>
                    ...
                    <div class="relative flex items-center justify-between pt-6 border-t border-white/10">
                        <div class="flex items-center gap-3 text-white">
                            ...
                            <p class="text-blue-50 text-[11px] font-bold tracking-wide"><?= $user['department'] ?></p>
                        </div>
    ...
    <script>
        ...
        function showQR() {
            ...
            if (!qr) {
                ...
                qr = new QRCode(qrContainer, { text: "<?= $user['student_id'] ?>", width: 180, height: 180, colorDark : "#0f172a", colorLight : "#ffffff", correctLevel : QRCode.CorrectLevel.H });
            }
        }
